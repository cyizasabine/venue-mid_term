...
import rw.hotel.venue.service.EmailService;
...
public class ForgotPasswordController {
    ...
    public ResponseEntity<String> processForgotPassword(@RequestBody Map<String, String> request) {
        ...
        String body = "Venue!\n\nWe received a request to reset your password for your Venue account. To reset it, simply click the link below:\n"
                + resetLink
